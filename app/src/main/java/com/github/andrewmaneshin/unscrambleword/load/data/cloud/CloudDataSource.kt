...
interface CloudDataSource {
    ...
    class Base(
        ...
        override suspend fun load(): Array<String> {
            ...
            if (result.isSuccessful) {
                ...
                if (status in 200..299) {
                    ...
                    if (list.isEmpty()) {
                        return throw IllegalStateException("service unavailable")
                    } else {
                        return list
                    }
                } else {
                    throw IllegalArgumentException(handleResponseCode(status))
                }
            } else {
